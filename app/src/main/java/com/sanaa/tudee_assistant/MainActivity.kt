...
import com.sanaa.tudee_assistant.data.local.utils.getAssetsImagePainter
import com.sanaa.tudee_assistant.data.local.utils.getDefaultCategories
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                var defaultCategories by remember { mutableStateOf(listOf<CategoryLocalDto>()) }
